...
function setup() {
	...
	text('4.7:1', 60.0, 76.66666666666667)
	fill (rectColor);
	rect (120.0, 10.0, 100);
	fill (lightest);
	text('lightest', 170.0, 43.333333333333336)
	text('#FFFFFF', 170.0, 60.0)
	text('4.7:1', 170.0, 76.66666666666667)
	fill (rectColor);
	rect (230.0, 10.0, 100);
	fill (darkest);
	text('darkest', 280.0, 43.333333333333336)
	text('#000000', 280.0, 60.0)
	text('4.5:1', 280.0, 76.66666666666667)
	fill (rectColor);
	rect (340.0, 10.0, 100);
	fill (lighter);
	text('lighter', 390.0, 43.333333333333336)
	text('#FBFBFB', 390.0, 60.0)
	text('4.5:1', 390.0, 76.66666666666667)
	fill (rectColor);
	rect (450.0, 10.0, 100);
	fill (light);
	text('light', 500.0, 43.333333333333336)
	text('#F0F0F0', 500.0, 60.0)
	text('4.1:1', 500.0, 76.66666666666667)
	fill (rectColor);
	rect (10.0, 120.0, 100);
	fill (darker);
	text('darker', 60.0, 153.33333333333334)
	text('#1C1C1C', 60.0, 170.0)
	text('3.6:1', 60.0, 186.66666666666669)
	fill (rectColor);
	rect (120.0, 120.0, 100);
	fill (yellow);
	text('yellow', 170.0, 153.33333333333334)
	text('#F5DC23', 170.0, 170.0)
	text('3.4:1', 170.0, 186.66666666666669)
	fill (rectColor);
	...
	text('UI element color: middle-gray, #747474', 10.0, 235.0)
	saveCanvas('contrast_combinations_light_subcolor_middle-gray')
}
