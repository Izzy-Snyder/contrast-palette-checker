...
function setup() {
	...
	text('3.3:1', 60.0, 186.66666666666669)
	fill (rectColor);
	...
	text('UI element color: medium-light, #D9D9D9', 10.0, 235.0)
	saveCanvas('contrast_combinations_dark_subcolor_medium-light')
}
