...
function setup() {
	...
	text('3.4:1', 60.0, 186.66666666666669)
	fill (rectColor);
	...
	text('UI element color: yellow, #F5DC23', 10.0, 235.0)
	saveCanvas('contrast_combinations_dark_subcolor_yellow')
}
