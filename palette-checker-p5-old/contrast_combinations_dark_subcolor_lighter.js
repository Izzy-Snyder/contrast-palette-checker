...
function setup() {
	...
	text('3.1:1', 500.0, 186.66666666666669)
	fill (rectColor);
	textAlign(LEFT);
	textSize(10.666666666666666);
	text('background: darker, #1C1C1C', 10.0, 247.5)
	text('UI element color: lighter, #FBFBFB', 10.0, 235.0)
	saveCanvas('contrast_combinations_dark_subcolor_lighter')
}
